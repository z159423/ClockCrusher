...
public class AutoBuilder
{
    ...
    //Jenkins를 활용하기 위해 폴더 안에 넣는경우
    // static string TARGET_DIR = Application.dataPath.Substring(0, Application.dataPath.LastIndexOf('/')) + "/Builds/Android/";
